...
@IBDesignable class SHCircleBar: UITabBar {
    ...
    override func draw(_ rect: CGRect) {
        let fillColor: UIColor = UIColor(named: "Selection")!
        ...
        mask.fillColor = UIColor(named: "Selection")!.cgColor
    ...
    func customInit() {
        self.tintColor = UIColor(named: "BackColor")
        self.barTintColor = UIColor(named: "BackColor")
